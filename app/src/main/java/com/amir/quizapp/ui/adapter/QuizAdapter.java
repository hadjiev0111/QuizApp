...
import com.amir.quizapp.databinding.QuizItemBinding;
import java.util.ArrayList;
import java.util.List;

public class QuizAdapter extends RecyclerView.Adapter<com.amir.quizapp.ui.adapter.QuizAdapter.QuizViewHolder> {
